  ...
  return (
    <div className='px-[8%] mt-15'>
      <div className='flex items-center gap-4'>
        ...
        <h2 className='text-[#DB4444] font-bold text-xl'>Featured</h2>
      </div>
        ...
        <div className='w-[50.5%] flex flex-col justify-between'>
          <div className='h-fit relative border bg-black flex'>
            <div className='p-5 leading-10'>
              <h2 className='text-white font-bold text-lg'>Woman's Collection</h2>
              <p className='text-white text-md'>Featured woman collections that give you another vibe.</p>
              <button className='text-white text-md border-b-2 border-gray-400'>Shop Now</button>
            </div>
