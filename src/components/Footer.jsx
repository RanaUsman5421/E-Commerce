        ...
        <div className='bg-black mt-20 h-fit px-[8%] font'>
            <div className='h-fit flex justify-between text-white'>
                ...
                <div className='h-fit w-[19%] py-10 px-5'>
                    ...
                    <p className='font-semibold mt-2 text-sm'>Subscribe</p>
                    <p className='mt-3 text-sm'>Get 10% off your first order</p>

                    <div className='mt-3'>
                        <input type="text" placeholder='Enter Email' className='py-1 px-2 border-gray-300 border text-sm rounded-lg w-[90%]'/>
                ...
                <div className='h-fit w-[19%] py-10 px-5'>
                    ...
                    <p className='mt-3 text-sm'>111 Bijoy sarani, Dhaka,  DH 1515, Bangladesh.</p>
                    <p className='mt-5 text-sm'>exclusive@gmail.com</p>
                    <p className='mt-5 text-sm'>+88015-88888-9999</p>
                ...
                <div className='h-fit w-fit py-10 px-5'>
                    ...
                    <ul className='leading-9 text-sm'>
                        ...
                        <li><a href="" className='text-sm'>Login/Register</a></li>
                        <li><a href="" className='text-sm'>Cart</a></li>
                        <li><a href="" className='text-sm'>Wishlist</a></li>
                ...
                <div className='h-fit w-[25%] py-10 px-5'>
                    ...
                    <p className='mt-5 text-sm'>Save $3 with App New User Only</p>
