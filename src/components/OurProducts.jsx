    ...
    return (
        <div className='px-[8%] mt-20'>
            <div className='flex items-center gap-4'>
                ...
                <h2 className='text-[#DB4444] font-bold text-2xl'>Our Products</h2>
            </div>
            <div className='flex items-center justify-between py-2 gap-28'>
                <div className='flex items-center gap-15'>
                    <h2 className='text-5xl font-bold'>Explore Our Products</h2>
                </div>
            ...
            <div className='h-fit w-full mt-15 flex flex-wrap justify-between'>


                {
                    OurProduct.map((product, index) => (
                        <div key={index} className='h-[400px] w-[22%] min-w-[22%]  p-2'>
                            <div className='h-full'>
                                ...
                                <div className='w-fit mt-2 flex flex-col gap-1'>
                                    ...
                                    <div className='py-1 flex items-center gap-1.5 starsdiv'>
                                        ...
                                        <img src={assets.Star} alt="" />
                                        <img src={assets.Star} alt="" />
                                        <p className='text-xl text-[#DB4444] font-semibold'>{product.price}</p>
                                    </div>
                                </div>
                            </div>
