          ...
          <div className=' h-fit mt-20 flex'>
            ...
            <div className='w-[40%] flex justify-end items-center'>
              <form action="" className='w-[75%] h-fit'>
                <h2 className='font-semibold text-5xl'>Login to Exclusive</h2>
                ...
                <button className='bg-[#DB4444] text-white text-lg px-7 py-1.5 mt-8 rounded-sm'>Login</button>
                <a href="" className='text-[#DB4444] font-semibold'>Forgot Password?</a>
                </div>
