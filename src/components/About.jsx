...
const About = () => {
  return (
    <div className='px-[8%] mt-20'>
      <p> <span className='text-gray-400'>Home/</span>About</p>

      <div className='mt-20 h-[80vh] flex'>
        <div className='w-[50%] flex flex-col justify-center pl-0 p-25  h-[100%]'>
          <h1 className='text-6xl font-semibold'>Our Story</h1>
          <p className='mt-8 text-lg'>Launced in 2015, Exclusive is South Asia’s premier online shopping makterplace with an active presense in Bangladesh. Supported by wide range of tailored marketing, data and service solutions, Exclusive has 10,500 sallers and 300 brands and serves 3 millioons customers across the region. </p>
          <p className='mt-8 text-lg'>Exclusive has more than 1 Million products to offer, growing at a very fast. Exclusive offers a diverse assotment in categories ranging  from consumer.</p>
        </div>
      ...
      <div className='h-70 mt-20 p-5 flex justify-between font'>
        <div className='border border-gray-400 rounded-lg group transition-color duration-300 ease-in-out hover:bg-[#DB4444] h-[100%] w-[22%] flex flex-col items-center justify-center'>
          ...
          <p className='text-5xl font-bold mt-3 group-hover:text-white'>10.5K</p>
          <p className='mt-3 group-hover:text-white'>Sallers active our site</p>
        </div>
        ...
        <div className='border border-gray-400 rounded-lg h-[100%] w-[22%] group transition-color duration-300 ease-in-out hover:bg-[#DB4444] flex flex-col items-center justify-center'>
          ...
          <p className='text-5xl font-bold mt-3 group-hover:text-white'>33K</p>
          <p className='mt-3 group-hover:text-white'>Monthly Product Sales</p>
        </div>
        ...
        <div className='border border-gray-400 rounded-lg group transition-color duration-300 ease-in-out hover:bg-[#DB4444] h-[100%] w-[22%] flex flex-col items-center justify-center'>
          ...
          <p className='text-5xl font-bold mt-3 group-hover:text-white'>45.5K</p>
          <p className='mt-3 group-hover:text-white'>Customer active in our site</p>
        </div>
        ...
        <div className='border border-gray-400 rounded-lg group transition-color duration-300 ease-in-out hover:bg-[#DB4444]  h-[100%] w-[22%] flex flex-col items-center justify-center'>
          ...
          <p className='text-5xl font-bold mt-3 group-hover:text-white'>25K</p>
          <p className='mt-3 group-hover:text-white'>Annual gross sale in our site</p>
        </div>
      </div>
      ...
      <div className='h-fit mt-20 flex justify-between'>
        ...
        {AboutData.map(item => (<div>
          <div className='bg-gray-100 w-fit py-5 px-10 pb-0'>
            <img src={item.img} alt="" />
          </div>
          <p className='text-4xl font-semibold mt-4'>{item.name}</p>
