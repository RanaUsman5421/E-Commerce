...
const Cart = () => {
    return (
        <div className='px-[8%] mt-20'>
            ...
            <div className='mt-20 font flex flex-col gap-15'>
                <div className='h-15 rounded-lg grid grid-cols-4 items-center shadow-lg shadow-gray-300 border px-3'>
                    <p>Product</p>
                    <p>Price</p>
                    <p>Quantity</p>
                    <p>Subtotal</p>
                ...
                <div className='h-15 rounded-lg shadow-lg shadow-gray-300 grid grid-cols-4 items-center border px-3'>
                ...
                <div className='h-15 rounded-lg shadow-lg grid grid-cols-4 items-center content-center shadow-gray-300 border px-3'>
                    <div className='flex items-center gap-4'><img src={assets.Product3} alt="" width={'50px'} /> <p>LCD Monitor</p> </div>
                    <p>$650</p>
                    <div className='flex gap-2 px-3 p-1 rounded-lg border-gray-600 items-center'>
                        <p className='text-xl text-gray-500'>1</p>
            ...
            <div className='mt-10 flex justify-between'>
                <button className='border-2 border-gray-400 px-8 py-3 rounded-lg text-lg'>Return to Shop</button>
                <button className='border-2 border-gray-400 px-8 py-3 rounded-lg text-lg'>Update Cart</button>
            </div>

            <div className='mt-15'>
                <input type="text" placeholder='Coupon Code' className='border border-gray-400 px-2 py-3 rounded-lg w-[18%]' />
