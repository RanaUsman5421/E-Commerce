    ...
    return (
        <div className='px-[8%] mt-20'>
            <div className='flex items-center gap-4'>
                ...
                <h2 className='text-[#DB4444] font-bold text-2xl'>This Month</h2>
            </div>
            <div className='flex items-center justify-between py-2 gap-28'>
                ...
                <div className='h-fit flex gap-3 items-center'>
                    <button className='bg-[#DB4444] block px-8 m-auto text-white py-2 text-xl rounded-lg cursor-pointer mt-6'>View All</button>
                </div>
            </div>
