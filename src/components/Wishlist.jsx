    ...
    return (
        <div className='px-[8%] mt-20 font'>
            <div className='flex justify-between items-center'>
                ...
                <button className='border px-8 py-3 rounded-lg'>Move All To Bag</button>
            </div>
            ...
            <div className='flex justify-between items-center mt-20'>
                <div className='flex items-center gap-4'>
                    ...
                    <h2 className='font-bold text-2xl'>Just For You</h2>
                </div>
            <button className='border px-8 py-3 rounded-lg'>See All</button>
            </div>
